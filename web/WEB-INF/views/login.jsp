...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" method="post" action="/system/login">
            <div class="row cl">
            ...
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    ...
                    <img title="点击图片切换验证码" id="vcodeImg" src="/system/get_verification_code"></div>
            </div>
...
<div class="footer">万象天宫 &nbsp; China @ looli </div>
</body>
</html>
<script type="text/javascript">
    $(function(){
        ...
        $("#vcodeImg").click(function(){
            this.src="/system/get_verification_code?t="+new Date().getTime();
        });
